...
DATABASES = {
   'default': {
       ...
       'NAME':     os.environ.get("POSTGRES_DB",       default='nopayloaddb'),
       'USER':     os.environ.get("POSTGRES_USER",     default='npdb'),
       'PASSWORD': os.environ.get("POSTGRES_PASSWORD", default='dev_password'),
       'HOST':     os.environ.get("POSTGRES_HOST",     default='localhost'),
       # 'PORT':     os.environ.get("POSTGRES_PORT",     default='5432'),
       'PORT': os.environ.get("POSTGRES_PORT", default='34457'),
